...
export const signUpSchema = z.object({
  ...
  bvn: z
    ...
    .refine((value) => !isNaN(value), {
      message: "BVN must be a valid number",
    }),
  nin: z
    .number()
    .refine((value) => !isNaN(value), {
      message: "NIN must be a valid number",
    }),
  pin: z
    .number()
    .refine((value) => !isNaN(value), {
  ...
  donationPreference: z
    .array(z.string())
    .nonempty("Please select at least one donation preference"), // Updated to accept an array of strings
});
...
export const compnanySchema = z.object({
  ...
  taxIdentificationNumber: z
    .string()
    .min(2, "Invalid tax identification number"),
