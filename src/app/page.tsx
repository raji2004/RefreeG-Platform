          ...
          <div className="bg-white w-full mt-8 mb-12 px-12 md:w-screen z-10">
            ...
            <div className="w-full py-6 flex justify-between items-center whyus">
              <div className="flex w-1/5 flex-col space-y-2">
                ...
                <a
                  href="#"
                  className="flex font-medium hover:text-blue-800 hover:underline transition duration-500 ease-in-out transform"
                >
                  Read more
              ...
              <div className="flex w-1/5 flex-col space-y-2">
                ...
                <p className="text-lg">
                  Every cause is carefully vetted to ensure your contributions
              ...
              <div className="flex w-1/5 flex-col space-y-2">
                ...
                <p className="text-lg">
                  Donate to causes with just a few clicks and track progress
