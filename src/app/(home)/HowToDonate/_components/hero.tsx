    ...
    <div className='px-10 w-full flex flex-col-reverse md:flex md:flex-row justify-between'>
        <div className='w-full lg:w-8/12'>
            <div className='w-full lg:w-5/6 mb-7'>
                <div className='text-2xl font-semibold pb-2 md:pb-4 lg:mb-4'>How To Donate 🌍💙</div>
                <div className='text-sm md:text-base lg:text-lg'>
                    At RefreeG, we are revolutionizing the way people give, receive, 
                    and track donations through a transparent, community-driven crowdfunding 
                    platform. At RefreeG, giving is simple, secure, and impactful. Follow these 
