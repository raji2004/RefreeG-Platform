...
export const FeatureCard: FC<FeatureCardProps> = ({ imageSrc, title, description, linkHref }) => (
  <div className="flex min-w-[40%] flex-col space-y-2  transform transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:bg-slate-50 pb-5 hover:rounded-xl p-4">
  ...
  >
    Read more
    <Image src={"/images/arrow-right.png"} alt="icon" width={25} height={25} />
  </Link>
</div>
