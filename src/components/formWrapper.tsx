...
export const FormWrapper = ({
  ...
  return (
    <div className="flex">
      {!hideSidebar && (
        <div className="hidden md:block w-[35%] p-6 bg-primaryShades-100/30 h-screen">
          ...
          <p className="text-palette-baseBlack mt-5">
            Start your journey with RefreeG today—empower lives, support causes,
            and make a lasting impact. Your account is the first step towards
      ...
      <div
        className={cn(
          "w-full md:w-[65%] p-6 flex flex-col items-center",
          hideSidebar && " md:w-full "
        )}
      >
        ...
        <div
          className={`flex-grow flex justify-center  items-center w-full md:w-fit h-screen md:h-fit ${
            hideSidebar ? "md:w-full  md:h-screen" : ""
          }`}
        >
          {children}
        </div>
