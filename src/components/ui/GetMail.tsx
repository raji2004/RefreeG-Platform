  ...
  return (
    <div>
      ...
      >
        ...
        <button className="bg-bold bg-[#036] text-white font-medium flex items-center justify-center text-[12px] h-[80%] absolute top-1 right-2 px-5 rounded-3xl cursor-pointer">
          Subscribe
        </button>
      </form>
