...
export const CauseDescription: FC<CauseDescriptionProps> = ({ imageSrc, title, points, linkHref }) => (
  <div className="lg:flex text-center mb-16 pb-10 border-b justify-between">
    <div className="self-center hidden lg:block">
      <Image src={imageSrc} alt={title} />
    </div>
    <div className="text-3xl self-center text-center font-medium w-full lg:w-3/12">{title}</div>
...
export function CausesSupported() {
  ...
  return (
    <div className="mr-10 ml-10">
      ...
      <div className="w-11/12 lg:w-8/12 mx-auto text-base md:text-xl text-center mt-10 mb-10">
