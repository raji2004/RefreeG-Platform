        ...
        <nav className="bg-white shadow-md w-full z-10">
            <div className="w-full px-4 py-6 flex justify-between items-center">
                ...
                <div className="flex space-x-4">
                    ...
                    <Link href="/List_a_cause" className="text-lg bg-blue-700 text-white px-5 py-2 rounded-sm transition duration-200 ease-in-out hover:bg-blue-900 transform hover:-translate-y-1 hover:scale-110">
                        List a cause
                    </Link>
